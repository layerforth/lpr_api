...
from .src.models.plate_detector_trt import PlateDetectorTRT
from .src.models.segmentator_trt import SegmentatorTRT
from .src.models.char_recognizer_trt import CharRecognizerTRT